...
require_once("$CFG->dirroot/filter/solentvideo/lib.php");
	...
	if ($streamingresource == 'No'){
		...
		if (($filetype != 'flv') && (strpos($_SERVER['HTTP_USER_AGENT'],"iPhone") !==false || strpos($_SERVER['HTTP_USER_AGENT'],"iPad") !==false|| strpos($_SERVER['HTTP_USER_AGENT'],"iPod") !==false || strpos($_SERVER['HTTP_USER_AGENT'],"Android") !==false )){////ITS AN MP4 SO PLAY IT ON IPAD WITH VIDEO TAG
					...
					*/
					...
					$output = '<br/> <div class="solent_videoWrapper"><video controls = "true" '.$size.' src="'.$mp4_url.'" ></video></div><br>';
	   ...
	   $output = ' <style>
				  ...
				  <script type="text/javascript" src="/filter/solentvideo/jwplayer.js"></script>
...
if (strpos($_SERVER['HTTP_USER_AGENT'],"iPad") !==false){
	//echo 'IT IS AN IPAD!!!!<br />';
					...
					if (strpos($_SERVER['REQUEST_URI'],"/mod/book/tool/exportepub/index.php") !== false){
						...
						$size = 'width="'.$width.'" height="232"';
						$output =  '<div class="solent_videoWrapper"><video src="'.$mp4_url.'" controls = "controls" '.$size.' poster = "'.$poster.'"></video></div>';
					}else{
					$output =  '<div class="solent_videoWrapper"><video src="'.$mp4_url.'" controls = "controls" '.$size.' poster = "'.$poster.'"></video></div><br>';
					}
